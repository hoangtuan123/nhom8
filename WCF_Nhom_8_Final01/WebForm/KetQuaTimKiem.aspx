<%@ Page Title="" Language="C#" MasterPageFile="~/New_Master.Master" AutoEventWireup="true" CodeBehind="KetQuaTimKiem.aspx.cs" Inherits="WebForm.KetQuaTimKiem" %>
<%@ Register assembly="CollectionPager" namespace="SiteUtils" tagprefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="text-align: center">
                <h2><strong style="text-align: center">KẾT QUẢ TÌM KIẾM</strong></h2><br />
                <asp:Label runat="server" ID="lbThongBaoLoi" ForeColor="Red"></asp:Label>

            </div><br />
<p>
    <asp:DataList ID="dlKetQua" runat="server" GridLines="Both" OnItemCommand="dlKetQua_ItemCommand" RepeatColumns="5" RepeatDirection="Horizontal">
        <ItemTemplate>
