...
namespace WebForm.CtDonDHServiceReference {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="CtDonDH", Namespace="http://schemas.datacontract.org/2004/07/WcfServices")]
    ...
    public interface ICtDonDHService {
        ...
        WebForm.CtDonDHServiceReference.CtDonDH[] HienThiCtDonDH(WebForm.CtDonDHServiceReference.CtDonDH ct);
        ...
        void Them(WebForm.CtDonDHServiceReference.CtDonDH ct);
        ...
        void Xoa(WebForm.CtDonDHServiceReference.CtDonDH ct);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ICtDonDHServiceChannel : WebForm.CtDonDHServiceReference.ICtDonDHService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CtDonDHServiceClient : System.ServiceModel.ClientBase<WebForm.CtDonDHServiceReference.ICtDonDHService>, WebForm.CtDonDHServiceReference.ICtDonDHService {
        ...
        public WebForm.CtDonDHServiceReference.CtDonDH[] HienThiCtDonDH(WebForm.CtDonDHServiceReference.CtDonDH ct) {
            return base.Channel.HienThiCtDonDH(ct);
        }
        
        public void Them(WebForm.CtDonDHServiceReference.CtDonDH ct) {
            base.Channel.Them(ct);
        }
        
        public void Xoa(WebForm.CtDonDHServiceReference.CtDonDH ct) {
            base.Channel.Xoa(ct);
        }
    }
}
